...
void show(NNTStructure::SingleLinkedList<int> ll) {
...
int main() {
    cout << "Start=======================" << endl;
// Append data
    NNTStructure::SingleLinkedList<int> test1;
    test1.append(1);
    test1.append(2);
    test1.append(4);
    test1.append(5);
...
// Copy constructor
    NNTStructure::SingleLinkedList<int> test2(test1);
...
// Copy constructor
    NNTStructure::SingleLinkedList<int> test3 = test1;
...
// Copy assignment
    NNTStructure::SingleLinkedList<int> test4;
    test4 = test1;
...
// Move constructor
    NNTStructure::SingleLinkedList<int> test5 = std::move(test3);
...
// Move assignment
    NNTStructure::SingleLinkedList<int> test6;
